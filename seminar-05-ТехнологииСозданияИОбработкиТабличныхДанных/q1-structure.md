...
> Электронные таблицы – мощный инструмент для хранения, обработки и анализа данных. Примененяются в бизнесе, науке, образовании и других сферах.
...
| **Строка** | Отдельный объект или запись | Информация об одной продаже (дата, товар, количество, цена) |
...
| **Защита ячеек** | Предотвращение случайных изменений | Защита ячеек с формулами, чтобы пользователь не мог случайно изменить или удалить их |
